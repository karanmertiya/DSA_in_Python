...
<table border="1">
  ...
  <tbody>
    ...
    <tr>
      <td rowspan="1">10</td>
      <td rowspan="1">Bm 16 Find The Original Array Of Prefix Xor<br><br></b> <a href='https://leetcode.com/problems/find-the-original-array-of-prefix-xor/' target='_blank'>LeetCode 2433</a></td>
      <td rowspan="1"><b>Example 1:</b> `pref = [5,2,0,3,1]`. Output: `[5,7,2,3,2]`.</td>
    ...
    <tr>
      <td rowspan="1">11</td>
      <td rowspan="1">Bm 17 Maximum Xor For Each Query<br><br></b> <a href='https://leetcode.com/problems/maximum-xor-for-each-query/' target='_blank'>LeetCode 1829</a></td>
      <td rowspan="1"><b>Example 1:</b> `nums = [0,1,1,3], maximumBit = 2`. Output: `[0,3,2,3]`.</td>
      <td><b>Time:</b> O(N)<br><b>Space:</b> O(N)</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      <td rowspan="1">12</td>
      <td rowspan="1">Bm 18 Minimum Flips To Make A Or B Equal To C<br><br></b> <a href='https://leetcode.com/problems/minimum-flips-to-make-a-or-b-equal-to-c/' target='_blank'>LeetCode 1318</a></td>
      <td rowspan="1"><b>Example 1:</b> Bit by bit analysis.</td>
    ...
    <tr>
      <td rowspan="1">13</td>
      <td rowspan="1">Bm 19 Number Of Steps To Reduce A Number To Zero<br><br></b> <a href='https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/' target='_blank'>LeetCode 1342</a></td>
      <td rowspan="1"><b>Example 1:</b> Simulation.</td>
    ...
    <tr>
      <td rowspan="1">14</td>
      <td rowspan="1">Bm 20 Decode Xored Array<br><br></b> <a href='https://leetcode.com/problems/decode-xored-array/' target='_blank'>LeetCode 1720</a></td>
      <td rowspan="1"><b>Example 1:</b> Sequential XOR.</td>
      <td><b>Time:</b> O(N)<br><b>Space:</b> O(N)</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      <td rowspan="1">15</td>
      <td rowspan="1">Bm 21 Find The Longest Substring Containing Vowels In Even Counts<br><br></b> <a href='https://leetcode.com/problems/find-the-longest-substring-containing-vowels-in-even-counts/' target='_blank'>LeetCode 1371</a></td>
      <td rowspan="1"><b>Example 1:</b> Bitmask and hashmap.</td>
    ...
    <tr>
      <td rowspan="1">16</td>
      <td rowspan="1">Bm 22 Subsets<br><br></b> <a href='https://leetcode.com/problems/subsets/' target='_blank'>LeetCode 78</a></td>
      <td rowspan="1"><b>Example 1:</b> Bitmasking technique.</td>
    ...
    <tr>
      <td rowspan="1">17</td>
      <td rowspan="1">Bm 23 Single Number Iii<br><br></b> <a href='https://leetcode.com/problems/single-number-iii/' target='_blank'>LeetCode 260</a></td>
      <td rowspan="1"><b>Example 1:</b> Grouping by rightmost set bit.</td>
      <td><b>Time:</b> O(N)<br><b>Space:</b> O(1)</td>
      <td>-</td>
    ...
    <tr>
      <td rowspan="1">18</td>
      <td rowspan="1">Bm 24 Divide Two Integers<br><br></b> <a href='https://leetcode.com/problems/divide-two-integers/' target='_blank'>LeetCode 29</a></td>
    ...
    <tr>
      <td rowspan="1">19</td>
      <td rowspan="1">Bm 25 Xor Queries Of A Subarray<br><br></b> <a href='https://leetcode.com/problems/xor-queries-of-a-subarray/' target='_blank'>LeetCode 1310</a></td>
      <td rowspan="1"><b>Example 1:</b> Prefix XOR array.</td>

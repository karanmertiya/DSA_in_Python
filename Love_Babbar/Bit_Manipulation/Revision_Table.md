...
<table border="1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><b>Explanation:</b> Bitwise AND between N and N-1 naturally flips the lowest set bit to 0.<br><br><details><summary><b>View Code</b></summary><pre style="white-space: pre-wrap; word-wrap: break-word;"><code class="language-python">def remove_last_set_bit(n: int) -&gt; int:&#10;    if n &lt;= 0: return 0&#10;    return n &amp; (n - 1)</code></pre></details></td>
    </tr>
    <tr>
      <td rowspan="2">3</td>

...
<table border="1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><b>Explanation:</b> Linearly traverse and ensure `arr[i] <= arr[i+1]`.<br><br><details><summary><b>View Code</b></summary><pre style="white-space: pre-wrap; word-wrap: break-word;"><code class="language-python">def is_sorted(arr: list[int]) -&gt; bool:&#10;    if len(arr) &lt;= 1: return True&#10;    for i in range(1, len(arr)):&#10;        if arr[i] &lt; arr[i - 1]:&#10;            return False&#10;    return True</code></pre></details></td>
    </tr>
    <tr>
      <td rowspan="2">3</td>

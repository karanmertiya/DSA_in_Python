...
<table border="1">
  ...
  <tbody>
    ...
    <tr>
      <td>12</td>
      <td>Tries 12 Word Break Trie<br><br></b> <a href='https://leetcode.com/problems/word-break/' target='_blank'>LeetCode 139</a></td>
      <td><b>Example 1:</b> Trie + DP / Memoization.</td>
      <td><b>Time:</b> O(N^2)<br><b>Space:</b> O(N + sum of word lengths in dict)</td>
      <td>Trie</td>
      <td>-</td>
      <td><b>Explanation:</b> Build a Trie with all words in `wordDict`. Use a recursive function with memoization `solve(i)` which returns true if the substring `s[i...]` can be segmented. Inside `solve(i)`, traverse the Trie starting from `s[i]`. If we reach a Trie node where `isEnd` is true, recursively call `solve(j+1)`. If any returns true, then `solve(i)` is true.<br><br><details><summary><b>View Code</b></summary><pre style="white-space: pre-wrap; word-wrap: break-word;"><code class="language-python">class TrieNode:&#10;    def __init__(self):&#10;        self.children = {}&#10;        self.isEnd = False&#10;class Solution:&#10;    def wordBreak(self, s: str, wordDict: list[str]) -&gt; bool:&#10;        root = TrieNode()&#10;        for word in wordDict:&#10;            node = root&#10;            for char in word:&#10;                if char not in node.children:&#10;                    node.children[char] = TrieNode()&#10;                node = node.children[char]&#10;            node.isEnd = True&#10;        memo = {}&#10;        def solve(i):&#10;            if i == len(s): return True&#10;            if i in memo: return memo[i]&#10;            node = root&#10;            for j in range(i, len(s)):&#10;                if s[j] not in node.children: break&#10;                node = node.children[s[j]]&#10;                if node.isEnd and solve(j + 1):&#10;                    memo[i] = True&#10;                    return True&#10;            memo[i] = False&#10;            return False&#10;        return solve(0)</code></pre></details></td>
    </tr>
    <tr>
      <td>13</td>
      <td>Tries 13 Print Anagrams Together<br><br></b> <a href='https://practice.geeksforgeeks.org/problems/print-anagrams-together/1' target='_blank'>GFG</a></td>
    ...
    <tr>
      <td>14</td>
      <td>Tries 14 Maximum Xor Subarray<br><br></b> <a href='https://practice.geeksforgeeks.org/problems/maximum-xor-subarray/1' target='_blank'>GFG</a></td>
    ...
    <tr>
      <td>15</td>
      <td>Tries 15 Design Add And Search Words Data Structure<br><br></b> <a href='https://leetcode.com/problems/design-add-and-search-words-data-structure/' target='_blank'>LeetCode 211</a></td>
    ...
    <tr>
      <td>16</td>
      <td>Tries 16 Implement Magic Dictionary<br><br></b> <a href='https://leetcode.com/problems/implement-magic-dictionary/' target='_blank'>LeetCode 676</a></td>
    ...
    <tr>
      <td>17</td>
      <td>Tries 17 Find All Words In A Matrix<br><br></b> <a href='https://practice.geeksforgeeks.org/problems/find-all-words-in-a-matrix/1' target='_blank'>GFG</a></td>
    ...
    <tr>
      <td>18</td>
      <td>Tries 18 Replace Words<br><br></b> <a href='https://leetcode.com/problems/replace-words/' target='_blank'>LeetCode 648</a></td>
    ...
    <tr>
      <td>19</td>
      <td>Tries 19 Longest Word In Dictionary<br><br></b> <a href='https://leetcode.com/problems/longest-word-in-dictionary/' target='_blank'>LeetCode 720</a></td>
      <td><b>Example 1:</b> Trie + DFS.</td>
    ...
    <tr>
      <td>20</td>
      <td>Tries 20 Camelcase Matching<br><br></b> <a href='https://leetcode.com/problems/camelcase-matching/' target='_blank'>LeetCode 1023</a></td>
      <td><b>Example 1:</b> Trie matching.</td>
    ...
    <tr>
      <td>21</td>
      <td>Tries 21 Prefix And Suffix Search<br><br></b> <a href='https://leetcode.com/problems/prefix-and-suffix-search/' target='_blank'>LeetCode 745</a></td>
